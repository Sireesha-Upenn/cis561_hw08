...
void Scene::SetThinLensCamera(const ThinLensCamera &tc)
{
    thinLensCamera = ThinLensCamera(tc);
    thinLensCamera.create();
    film.SetDimensions(tc.width, tc.height);
}
