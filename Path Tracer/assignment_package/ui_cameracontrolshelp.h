...
public:
    ...
    void retranslateUi(QWidget *CameraControlsHelp)
    {
        ...
        label_11->setText(QCoreApplication::translate("CameraControlsHelp", "G: Move render camera to preview camera", nullptr));
        label_12->setText(QCoreApplication::translate("CameraControlsHelp", "F: Move preview camera to render camera", nullptr));
